...
if __name__ == "__main__":
    # Configuration for instances where pA > pB (p1 > p2)
    ...
    base_params = {
        ...
        "lambdaA": 8, "lambdaB": 5,
        "h": 0.1,
        "pA": 20.0, "pB": 10.0,  # pA > pB (Unequal penalties)
        "cf": 20.0, "cu": 1.0,
    ...
    instances_to_run = [
        ...
        # 3. High Penalty (N=20)
        # Note: This overrides base_params to make pA and pB even larger/equal if desired,
        # but here we keep the specific override logic you had.
        # If you want pA > pB here too, ensure these values match your intent.
        {
            "label": "Thm1_HighPenalty",
            "params": {**base_params, "N": 20, "pA": 30.0, "pB": 15.0}
        },
    ...
    OUTPUT_DIR = "Thm1_Verify_p1larger"
